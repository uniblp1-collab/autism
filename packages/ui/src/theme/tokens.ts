...
export const categoryColorTokens: Record<string, CategoryColorToken> = {
  ...
  // Цвета зафиксированы отдельно от 9 базовых категорий. Редакция 2 патча
  // (TASK_PATCH_1.md §3) поменяла решение на противоположное: Да — синяя, Нет — красная.
  "#B91C1C": { bg: "#F6C6C6", fg: "#7A1414" }, // Нет
