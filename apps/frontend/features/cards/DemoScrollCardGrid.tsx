  ...
  return (
    <div
      ...
      style={{
        ...
        // Без этого на тач-устройствах браузер пытается сразу скроллить по touchstart и
        // PointerSensor не успевает поймать долгое нажатие (см. рекомендацию @dnd-kit для
        // тач-сенсоров). Действует только пока карточки перетаскиваемые (reorderable), поэтому
        // обычный (не редактирование) просмотр сохраняет нативный скролл без ограничений.
        touchAction: "none",
        width: tileSize,
        height: tileSize,
      }}
